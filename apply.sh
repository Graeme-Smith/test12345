...
original_author="Graeme-Smith"
original_name="test12345"
original_urlname="test12345"
original_description="Awesome test12345 created by Graeme-Smith" 
...
rm -rf "${name}"
rm -rf tests
cp -R ${TEMPLATE_DIR}/test12345 "${name}"
...
then
    ...
    echo "then run 'test12345' or 'python -m test12345'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'test12345' or 'python -m test12345' or 'poetry run test12345'"
fi
